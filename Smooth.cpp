...

{
	...
	DDX_Text(pDX, IDC_EDIT_V0, m_Arr[0]);

	DDX_Text(pDX, IDC_EDIT_V1, m_Arr[1]);

	DDX_Text(pDX, IDC_EDIT_V2, m_Arr[2]);

	DDX_Text(pDX, IDC_EDIT_V3, m_Arr[3]);

	DDX_Text(pDX, IDC_EDIT_V4, m_Arr[4]);

	DDX_Text(pDX, IDC_EDIT_V5, m_Arr[5]);

	DDX_Text(pDX, IDC_EDIT_V6, m_Arr[6]);

	DDX_Text(pDX, IDC_EDIT_V7, m_Arr[7]);

	DDX_Text(pDX, IDC_EDIT_V8, m_Arr[8]);

	DDX_Text(pDX, IDC_EDIT_V9, m_Arr[9]);

	DDX_Text(pDX, IDC_EDIT_V10, m_Arr[10]);

	DDX_Text(pDX, IDC_EDIT_V11, m_Arr[11]);

	DDX_Text(pDX, IDC_EDIT_V12, m_Arr[12]);

	DDX_Text(pDX, IDC_EDIT_V13, m_Arr[13]);

	DDX_Text(pDX, IDC_EDIT_V14, m_Arr[14]);

	DDX_Text(pDX, IDC_EDIT_V15, m_Arr[15]);

	DDX_Text(pDX, IDC_EDIT_V16, m_Arr[16]);

	DDX_Text(pDX, IDC_EDIT_V17, m_Arr[17]);

	DDX_Text(pDX, IDC_EDIT_V18, m_Arr[18]);

	DDX_Text(pDX, IDC_EDIT_V19, m_Arr[19]);

	DDX_Text(pDX, IDC_EDIT_V20, m_Arr[20]);

	DDX_Text(pDX, IDC_EDIT_V21, m_Arr[21]);

	DDX_Text(pDX, IDC_EDIT_V22, m_Arr[22]);

	DDX_Text(pDX, IDC_EDIT_V23, m_Arr[23]);

	DDX_Text(pDX, IDC_EDIT_V24, m_Arr[24]);
...

{
...

	{
...

		{
			...
			m_Arr[i * m_iTempW + j] = m_Arr[i * 5 + j];
